...
namespace ApiNetTransportes.Controllers
{
    ...
    [ApiController]
    public class FiltroCochesController : ControllerBase
    {
        private RepositoryCoches repo;
        public FiltroCochesController(RepositoryCoches repo)
        {
            this.repo = repo;
        }
        // GET: api/coches
        ...
        [HttpGet]
        public async Task<ActionResult<List<FiltroCoche>>> Get()
        {
            return await this.repo.GetFiltroCoches();
        }
    }
}
